...
export type AgendaTalksListQuery = (
 ...
 * });
 */
export function useAgendaTalksListQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<AgendaTalksListQuery, AgendaTalksListQueryVariables>) {
        return ApolloReactHooks.useQuery<AgendaTalksListQuery, AgendaTalksListQueryVariables>(AgendaTalksListDocument, baseOptions);
      }
export function useAgendaTalksListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<AgendaTalksListQuery, AgendaTalksListQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<AgendaTalksListQuery, AgendaTalksListQueryVariables>(AgendaTalksListDocument, baseOptions);
        }
export type AgendaTalksListQueryHookResult = ReturnType<typeof useAgendaTalksListQuery>;
export type AgendaTalksListLazyQueryHookResult = ReturnType<typeof useAgendaTalksListLazyQuery>;
export type AgendaTalksListQueryResult = ApolloReactCommon.QueryResult<AgendaTalksListQuery, AgendaTalksListQueryVariables>;